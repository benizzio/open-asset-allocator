...
- Adapter
- generate_report.py
- portfolio_divergence_analysis_context.go
...
- .generateDivergenceAnalysisFromPortfolioAllocationSet
...
Cohesion: 0.06
Nodes (47): DomainValidationError, UniqueConstraintViolationError, CustomSlice[T], AllocationHierarchyLevelDTS, AllocationStructureDTS, allocationPlanValidationData, levelSliceSizeValidationData, mapToAllocationHierarchyLevelDTSs() (+39 more)

### Community 1 - "Adapter"
Cohesion: 0.05
Nodes (32): database/sql.DB, database/sql.Result, database/sql.Row, database/sql.Rows, database/sql.Tx, github.com/go-ozzo/ozzo-dbx.DB, github.com/go-ozzo/ozzo-dbx.Query, github.com/go-ozzo/ozzo-dbx.Rows (+24 more)
...
### Community 3 - "portfolio_divergence_analysis_context.go"
Cohesion: 0.14
Nodes (18): contextKey, divergenceAnalysisContextValue, potentialDivergencesPerHierarchicalId, PlannedAllocation, buildDivergenceAnalysisContext(), buildPotentialDivergenceMapContext(), getDivergenceAnalysisContextValue(), getPotentialDivergenceMapContextValue() (+10 more)
...
### Community 6 - "portfolio-history-management.ts"
Cohesion: 0.11
Nodes (12): Application, allocationPlanManagement, AssetComposedColumnsInput, notifications, FormRowValueElements, getNextPortfolioHistoryManagementIndex(), portfolioHistoryManagement, AfterRequestEventDetail (+4 more)
...
### Community 8 - "go_pkg_github_com_benizzio_open_asset_allocator_langext"
Cohesion: 0.13
...
Cohesion: 0.14
Nodes (13): go_pkg_database_sql, go_pkg_database_sql_driver, go_pkg_fmt, go_pkg_github_com_benizzio_open_asset_allocator_infra_rdbms_sqlext, go_pkg_github_com_shopspring_decimal, go_pkg_time, database/sql.Stmt, time.Time (+5 more)

### Community 12 - "github.com/gin-gonic/gin.Context"
Cohesion: 0.15
Nodes (17): github.com/gin-gonic/gin.Context, AssetRESTController, PortfolioAllocationRESTController, PortfolioRESTController, HandleAPIError(), handleDomainError(), handleInfrastructureError(), SendDataNotFoundResponse() (+9 more)

### Community 13 - "chart-utils.ts"
Cohesion: 0.09
Nodes (34): chartjs-plugin-datalabels, chart, chartContentRepo, getChartContent(), getChartContentFromChart(), loadChart(), buildChartInteractions(), buildChartOptions() (+26 more)

### Community 14 - "AssetDomService"
Cohesion: 0.15
Nodes (9): AllocationPlanRESTController, BuildAllocationPlanRESTController(), BuildAssetRESTController(), BuildAllocationPlanManagementAppService(), AllocationPlanManagementAppService, BuildPortfolioAllocationManagementAppService(), AssetRepository, AssetDomService (+1 more)
...
Cohesion: 0.12
Nodes (21): bignumber.js, chart.js, changeChartData(), chartDataSelectionEventHandler(), FractalPortfolioMultiChartDataSource, generateDataKey(), getChartContent(), interactionObserverCallback() (+13 more)
...
Cohesion: 0.14
Nodes (16): ExternalAssetData, AllocationPlanRDBMSRepository, AssetRDBMSRepository, S, Asset, buildAssetInsertValue(), buildAssetInsertValues(), BuildAppError() (+8 more)
...
Cohesion: 0.12
Nodes (17): portfolioAllocationJoinedRowDTS, PortfolioAllocationRDBMSRepository, BuildPortfolioAllocationRESTController(), PortfolioAllocationManagementAppService, mapNewAssetsPerTickerFromPortfolioAllocations(), replacePersistedAssetsOnPortfolioAllocations(), AssetsPerTicker, buildSelectedExternalAsset() (+9 more)

### Community 22 - "infra_db.go"
Cohesion: 0.11
Nodes (15): go_pkg_github_com_testcontainers_testcontainers_go_modules_postgres, go_pkg_sync, sync.Mutex, testing.TB, logFanOutConsumer, BuildDeferRegistry(), AttachDatabaseLogsTo(), appendDebugLoggingCommand() (+7 more)

### Community 23 - "allocation-plan.ts"
Cohesion: 0.17
Nodes (20): AllocationPlan, AllocationPlanDTO, CompleteAllocationPlan, FractalHierarchicalAllocationPlan, PlannedAllocationDTO, SerializableCompleteAllocationPlan, SerializableFractalHierarchicalAllocationPlan, SerializableFractalPlannedAllocation (+12 more)

### Community 24 - "golang_ext_util_concurrent.go"
Cohesion: 0.32
Nodes (17): context.CancelFunc, sync.WaitGroup, I, concurrentSliceResult, SliceFromItemWithContext, R, buildConcurrentInputChannel(), buildFlatMapWorkerCount() (+9 more)
...
Cohesion: 0.15
Nodes (22): AllocationHierarchyLevelDTO, AllocationPlanType, ASSET_ALLOCATION_PLAN, BALANCING_EXECUTION_PLAN, AllocationStructure, AllocationStructureDTO, LOWEST_AVAILABLE_HIERARCHY_LEVEL, LOWEST_AVAILABLE_HIERARCHY_LEVEL_INDEX (+14 more)
...
Cohesion: 0.26
Nodes (16): AssetDTS, AssetSearchQueryDTS, ExternalAssetDataDTS, ExternalAssetDTS, ExternalAssetSearchQueryDTS, MapToAsset(), MapToAssetDTS(), MapToAssetDTSs() (+8 more)
...
Cohesion: 0.19
Nodes (19): arrayHelper(), comparatorHelper(), concatHelper(), eachReverseHelper(), getPropertyHelper(), ifEqualsHelper(), ifNotEqualsHelper(), ifNotNullishHelper() (+11 more)
...
### Community 52 - "ExternalAsset"
Cohesion: 0.10
Nodes (26): YahooFinanceAssetIntegrationService, AssetExternalSource, go_pkg_github_com_benizzio_open_asset_allocator_infra_util_http_httpclient, go_pkg_golang_org_x_text_currency, go_pkg_net_url, golang.org/x/text/currency.Unit, YahooFinanceChartDTS, YahooFinanceChartIndicatorsDTS (+18 more)
...
Cohesion: 0.21
Nodes (13): bindBootstrapValidationCleaning(), bindBootstrapValidationOnSubmit(), bindBootstrapValidationToDefaultForm(), bindFormsInDescendants(), addDisplayObserver(), bindExclusiveDisplay(), bindExclusiveDisplayContainerInDescendants(), bindExclusiveDisplayInDescendants() (+5 more)
...
### Community 72 - "assets.ts"
Cohesion: 0.13
Nodes (6): AssetDTO, AssetRequestEvent, ExternalAssetData, normalizeAsset(), parseJSON(), readAssetJSON()
...
### Community 76 - "context.Context"
Cohesion: 0.17
Nodes (15): allocationIterationMappingContextValue, context.Context, buildAllocationIterationContext(), buildHierarchySubIterationContext(), getAllocationIterationContextValue(), getHierarchySubIterationContextValue(), attachToRootIfTopLevel(), buildAndAttachPotentialDivergenceIfNotExists() (+7 more)
...
### Community 78 - "allocation-plan-management.ts"
Cohesion: 0.13
Nodes (15): addPlannedAllocationRow(), AllocationPlanningHierarchicalFormEntry, FormRowHierarchicalStructure, getHierarchicalFieldForValidation(), mapFormRowHierarchicalStructure(), mapPlannedAllocationFormEntriesPerHierarchicalKey(), setHierarchicalIdFromParentRow(), AssignAtPathOptions (+7 more)

### Community 79 - "htmx/index.ts"
Cohesion: 0.18
Nodes (15): APIErrorResponse, bindHTMXTransformResponseInDescendants(), addEventListeners(), configEnhancedRequestEventListener(), EventDetail, prepareFormData(), replaceRequestPathParams(), replaceRequestPathParamsFromCurrentRoute() (+7 more)
...
Cohesion: 0.23
Nodes (7): htmx.org, api, APIError, ASSET_ACTION_BUTTON_IDENTITIES, Asset, BootstrapClasses, BootstrapIconClasses
...
### Community 85 - "handlebars/index.ts"
Cohesion: 0.22
Nodes (13): handlebars, domJSONHelper(), registerHandlebarsDOMHelpers(), PARTIALS_REGISTRY, registerPartialToContainer(), getRenderIteratorMap(), isHelperOptions(), iteratorInitHelper() (+5 more)

### Community 86 - ".buildAppComponents"
Cohesion: 0.10
Nodes (18): AllocationStructure, AllocationRDBMSRepository, PortfolioRDBMSRepository, BuildPortfolioRESTController(), BuildPortfolioDivergenceAnalysisAppService(), AllocationRepository, BuildAllocationPlanRepository(), BuildAllocationRepository() (+10 more)

### Community 87 - "binding-htmx-trigger-on-route.ts"
Cohesion: 0.24
Nodes (12): navigo, RequestConfigEventDetail, addDisableRouteRemovalObserver(), bindCleanOnExitRouteBehaviourOnElement(), bindHTMXTriggerOnRouteInDescendants(), bindRouteToHTMXEventOnElements(), bindRouteToHTMXTriggerOnElement(), CLEAN_ON_EXIT_HTMX_EVENT_HANDLERS (+4 more)

### Community 88 - ".generateDivergenceAnalysisFromPortfolioAllocationSet"
Cohesion: 0.27
Nodes (4): SliceIterator, SliceIterator[T], T, NewSliceIterator()

### Community 89 - "asset-management.e2e.spec.ts"
Cohesion: 0.18
...
### Community 94 - "golang_ext_util_concurrent_test.go"
Cohesion: 0.24
...
### Community 97 - "binding-htmx-wait-for-ready.ts"
Cohesion: 0.50
...
### Community 98 - "PortfolioDivergenceAnalysisAppService"
Cohesion: 0.38
Nodes (6): DivergenceAnalysisRESTController, BuildDivergenceAnalysisRESTController(), BuildPortfolioAnalysisConfigurationAppService(), PortfolioAnalysisConfigurationAppService, buildDivergenceAnalysis(), PortfolioDivergenceAnalysisAppService
...
### Community 104 - "application/portfolio-analysis.ts"
Cohesion: 0.38
...
### Community 154 - "MapToPortfolioDTS"
Cohesion: 0.67
Nodes (4): PortfolioDTS, MapToPortfolio(), MapToPortfolioDTS(), MapToPortfolioDTSs()
...
- **Why does `PlannedAllocation` connect `IsZeroValue` to `allocation_plan_domain_service.go`, `portfolio_divergence_analysis_context.go`, `HierarchicalId`, `rdbms_adapter.go`, `PropagateAsAppErrorWithNewMessage`, `allocation_plan_rest_model.go`, `portfolio_rest_mapping.go`?**
  _High betweenness centrality (0.011) - this node is a cross-community bridge._
- **Why does `Adapter` connect `Adapter` to `rdbms_adapter.go`, `GinServer`?**
  _High betweenness centrality (0.010) - this node is a cross-community bridge._
- **Why does `Asset` connect `PropagateAsAppErrorWithNewMessage` to `allocation_plan_domain_service.go`, `IsZeroValue`, `Adapter`, `asset_rest_model.go`, `AssetDomService`, `PortfolioAllocation`, `insertTestAsset`, `allocation_plan_rest_model.go`?**
