...
FROM read_csv(
        ...
        columns = {
            ...
            'unrealized_gains': 'NUMERIC(18,8)',
            'realized_gains': 'NUMERIC(18,8)',
            'dividends': 'NUMERIC(18,8)',
            'currency_gains': 'NUMERIC(18,8)',
...
CREATE TEMP VIEW portfolio_allocation_fact_insertion AS
    SELECT
        ...
        swss.current_value / swss.total_shares as asset_market_price,
        if(
            adm.asset_quantity > 0,
            adm.asset_quantity::DECIMAL(30,8) * (swss.current_value / swss.total_shares)::DECIMAL(30,8),
            swss.current_value
