...
// TestGetAvailablePortfolioAllocationClassesFromAllSources tests the unified endpoint
// that retrieves allocation classes from both portfolio_allocation_fact and planned_allocation tables.
// Portfolio 1 has "BONDS" and "STOCKS" classes in both tables, so the result should be the same.
//
// Authored by: GitHub Copilot
func TestGetAvailablePortfolioAllocationClassesFromAllSources(t *testing.T) {
...
// when portfolio has classes only in planned_allocation (allocation plans).
