...
// arrayIndexPattern is the regex pattern used to identify array index notation (this pattern was generated by AI)
var arrayIndexPattern = regexp.MustCompile(`^(.+)\[(\d+)]$`)

// AssertJSONEqualIgnoringFields compares two JSON strings for equality after removing specified fields. (this function was generated by AI)
//
...
// removeNestedField removes a nested field specified by a dot-notation path. (this function was generated by AI)
...
// removeNestedFieldRecursive recursively traverses the data structure to remove a field. (this function was generated by AI)
...
// isArrayIndexNotation checks if a path segment uses array index notation like "field[0]" (this function was generated by AI)
func isArrayIndexNotation(pathSegment string) bool {
	return len(arrayIndexPattern.FindStringSubmatch(pathSegment)) > 0
}

// extractArrayIndexInfo extracts the field name and index from an array index path segment (this function was generated by AI)
...
// handleArrayIndexPath processes a path segment that contains array index notation (this function was generated by AI)
...
// handleRegularFieldPath processes a regular field path segment (this function was generated by AI)
...
// processArrayElements applies the operation to all elements in an array (this function was generated by AI)
...
// handleFinalRemoval removes the specified field from the final object in the path. (this function was generated by AI)
